...
PoWForLoop::PoWForLoop() : AbstractContainerHashAlgorithmElement() {
	this->loops = 0;
}

PoWForLoop::~PoWForLoop() {

}

void PoWForLoop::calulate(const char *in01, const char *in02, const char *in03,	char *out) const noexcept {
	char* arrays[4];
