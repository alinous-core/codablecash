...
#include "TestDbSchema3Index01.h"
...
TestDbSchema3Index01::TestDbSchema3Index01(TestEnv* env) : TestDbSchemaBase(env) {

}

TestDbSchema3Index01::~TestDbSchema3Index01() {

}

void TestDbSchema3Index01::init(uint64_t memCapacity) {
	TestDbSchemaBase::init(memCapacity);
	createTable();
	createIndex();
}

void TestDbSchema3Index01::createTable() {
...
void TestDbSchema3Index01::createIndex() {
	...
	}
	{
		...
		command->addColumn(new UnicodeString(L"comment"));
...
void TestDbSchema3Index01::insert01() {
	CdbTransaction* trx = getDatabase()->newTransaction(); __STP(trx);
...
void TestDbSchema3Index01::insertRecord(CdbTransaction *trx, int id, const wchar_t *name, int email_id, const wchar_t *comment) {
