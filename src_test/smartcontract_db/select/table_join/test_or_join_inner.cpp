...
TEST_GROUP(TestJoinOrJoinInnerGroup) {
	TEST_SETUP(){
		env->setup();
	}
	TEST_TEARDOWN(){
...
TEST(TestJoinOrJoinInnerGroup, case01){
	const File* projectFolder = this->env->getProjectRoot();
	_ST(File, sourceFile, projectFolder->get(L"src_test/smartcontract_db/select/table_join/resources/orjoininner/inner01/select01.alns"))
...
TEST(TestJoinOrJoinInnerGroup, case02){
	const File* projectFolder = this->env->getProjectRoot();
	_ST(File, sourceFile, projectFolder->get(L"src_test/smartcontract_db/select/table_join/resources/orjoininner/inner02/select01.alns"))
...
TEST(TestJoinOrJoinInnerGroup, case03){
	const File* projectFolder = this->env->getProjectRoot();
	_ST(File, sourceFile, projectFolder->get(L"src_test/smartcontract_db/select/table_join/resources/orjoininner/inner03/select01.alns"))
