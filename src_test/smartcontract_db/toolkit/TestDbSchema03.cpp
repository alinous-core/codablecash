...
TestDbSchema03::TestDbSchema03(TestEnv* env) : TestDbSchemaBase(env) {
}

TestDbSchema03::~TestDbSchema03() {
	this->list1.deleteElements();
	this->list2.deleteElements();
}

void TestDbSchema03::init() {
	TestDbSchemaBase::init();
}

void TestDbSchema03::init(uint64_t memCapacity) {
...
void TestDbSchema03::createTable() {
	createTestTable1();
	createTestTable2();
}

void TestDbSchema03::createTestTable1() {
...
void TestDbSchema03::createTestTable2() {
	CdbTransaction* trx = getDatabase()->newTransaction(); __STP(trx);
...
void TestDbSchema03::insertData() {
	insertData1();
	insertData2();
}

void TestDbSchema03::insertData1() {
	CdbTransaction* trx = getDatabase()->newTransaction(); __STP(trx);
...
void TestDbSchema03::insertRecord1(CdbTransaction* trx, int id,
...
void TestDbSchema03::insertData2() {
	CdbTransaction* trx = getDatabase()->newTransaction(); __STP(trx);
...
void TestDbSchema03::insertRecord2(CdbTransaction* trx, int email_id,
