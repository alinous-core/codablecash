...
#include "TestDbSchema1Index01.h"
...
TestDbSchema1Index01::TestDbSchema1Index01(TestEnv* env) : TestDbSchemaBase(env) {

}

TestDbSchema1Index01::~TestDbSchema1Index01() {

}

void TestDbSchema1Index01::init(uint64_t memCapacity) {
...
void TestDbSchema1Index01::createTable() {
...
void TestDbSchema1Index01::createIndex() {
	CodableDatabase* db = getDatabase();
	CdbTransaction* trx = db->newTransaction(); __STP(trx);
...
void TestDbSchema1Index01::insert01() {
...
void TestDbSchema1Index01::insertRecord(CdbTransaction *trx, int id, const wchar_t *name, int email_id, const wchar_t *comment) {
